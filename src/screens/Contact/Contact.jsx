  ...
  return(
    <div className="contact-screen">
      ...
      <main className="contact">
        ...
        <a href="https://www.instagram.com/flexibleidealist/" target="_blank" rel="noreferrer">instagram</a>
        <img src="/assets/icons/external-link-alt-solid.svg" alt="external link icon"></img>
        <a href="https://www.flexibleidealist.com/" target="_blank" rel="noreferrer">software engineering portfolio</a>
        <img src="/assets/icons/github-brands.svg" alt="github icon"></img>
        <a href="https://github.com/flexibleidealist" target="_blank" rel="noreferrer">github</a>
